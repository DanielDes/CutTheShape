...
class BezierPathBuilder {
    private var innerShapeScale: Double = 0.90
    ...
    func buildBackgroundShape(bound: CGRect) -> UIBezierPath {
        return UIBezierPath(arcCenter: CGPoint(x: bound.width * 0.5, y: bound.height * 0.5), radius: 150, startAngle: CGFloat(0), endAngle: CGFloat.pi * 2, clockwise: true)
    }
